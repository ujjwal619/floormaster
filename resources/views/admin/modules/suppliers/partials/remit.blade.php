<div class="row">
    ...
    <portlet-content :height="180" :onlybody="true" class="px-2 col-12">
      <div slot="body" class="p-2">
        <div class="row">
          ...
          <input type="text" class="form-control col-7 text-primary" :disabled="!isEditMode" v-model="remit.payee_name"/>
        </div>
        <div class="row pt-2">
          <label class="col-1 text-right pr-2">
            Street:  
          </label>
          <input type="text" class="form-control col-7" :disabled="!isEditMode" v-model="remit.payee_street"/>
        </div>
        <div class="row pt-2">
          <label class="col-1 text-right pr-2">
            Suburb:  
          </label>
          <input type="text" class="form-control col-7" :disabled="!isEditMode" v-model="remit.payee_town"/>
        </div>
        <div class="row pt-2">
          <label class="col-1 text-right pr-2">
            State:  
          </label>
          <input type="text" class="form-control col-3" :disabled="!isEditMode" v-model="remit.payee_state"/>
          <label class="col-1 text-right pr-2">
            Code:  
          </label>
          <input type="text" class="form-control col-3" :disabled="!isEditMode" v-model="remit.payee_code"/>
        </div>
      </div>
    </portlet-content>
  </div>
  <div class="col-2 row">
    <portlet-content :height="180" :onlybody="true" class="px-2 col-12">
      <div slot="body" class="p-2">
        <div class="row">
          <input type="text" :disabled="!isEditMode" v-model="remit.notes[0]"/>
        </div>
        <div class="row">
          <input type="text" :disabled="!isEditMode" v-model="remit.notes[1]"/>
        </div>
        <div class="row">
          <input type="text" :disabled="!isEditMode" v-model="remit.notes[2]"/>
        </div>
        <div class="row">
          <input type="text" :disabled="!isEditMode" v-model="remit.notes[3]"/>
        </div>
      </div>
    </portlet-content>
  </div>
    ...
    <portlet-content :height="600" :onlybody="true" class="col-12 px-2">
      <div slot="body" class="p-2">
            ...
            <table class="table">
              <tbody>
                <tr class="row col-12" v-for="item in remit.items">
                  ...
                  <td class="col-1">$@{{ item.net_payment }}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="table">
              <tbody>
                <tr class="row col-12">
                  ...
                  <td class="table-head col-4 text-right">@{{ remit.payment_type === 1 ? 'EFT' : 'CHEQUE' }}</td>
        ...
        <div class="col-12 row d-flex align-items-center">
          <label class="col-3 text-right text-primary">
            Cq A/C Balance after this Cheque
          </label>
          <input class="col-3" value="$"/>
        </div>
      </div>
    </portlet-content>
  </div>
