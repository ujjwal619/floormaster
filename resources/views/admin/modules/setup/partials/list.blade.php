<div class="form-container">
    ...
    <div class="col-xsmall-12 col-small-12">
        ...
        <div class="col-12 row">
            ...
            <div class="col-6 pt-1">
                <div class="row">
                    <portlet-content :height="475" :onlybody="true" class="col-12 px-2">
                        <div slot="body" class="form-group p-2">
                            ...
                            <div class="row pb-2">
                                ...
                                <input 
                                    :disabled="!isEditMode" 
                                    v-model="model.company_details.acn" 
                                    class="col-3 form-control text-primary" 
                                    type="number"
                                />
                                <label class="col-1 text-right">Group I.D.</label>
                                <input 
                                    :disabled="!isEditMode" 
                                    v-model="model.company_details.group_id" 
                    ...
                    <portlet-content :height="190" :onlybody="true" class="col-12 px-2">
                        <div slot="body" class="row pb-2 p-2">
                            <div class="col-lg-2">
                                <span class="background-black text-truncate">Business Unit</span>
                            </div>
                            <div class="col-lg-8 mt-1" style="max-height: 160px;overflow-y: scroll;">
                                <table class="short-table table table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width: 40%">Business Unit Name</th>
                                            <th style="width: 20%">GL Suffix</th>
                                            <th style="width: 40%">Letterhead Path</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="(shop, key) in shops" @dblClick="editShop(shop)">
                                            <td style="width: 40%" >
                                               @{{ shop.name }}
                                            </td>
                                            <td style="width: 20%">
                            ...
                            <div class="col-lg-2">
                                <button type="button" class="btn action-buttons" @click="openAddShopModal">Add</button>
                            </div>
                            <div class="col-lg-1">
                                &nbsp;
                            </div>
                    ...
                    <div class="col-xsmall-12 col-small-12 mt-1">
            ...
            <div class="col-6 pt-1">
                <div class="row">
                    <portlet-content :height="170" :onlybody="true" class="col-6 pl-2 pr-0">
                        <div slot="body" class="row pb-2 p-2">
                            <div class="col-lg-3">
                                <span class="background-black text-truncate ">Job Sources</span>
                            </div>
                            <div class="col-lg-7 mt-1" style="max-height: 130px;overflow-y: scroll; scrollbar-width: none;">
                                <table class="short-table table table-bordered">
                                    <tbody>
                    ...
                    <portlet-content :height="170" :onlybody="true" class="col-6 px-2">
                    <div slot="body" class="row pb-2 p-2">
                            <div class="col-lg-3">
                    ...
                    <portlet-content :height="395" :onlybody="true" class="col-12 px-2">
                        <div slot="body" class="p-2">
                            <div class="row">
    ...
    <template v-if="mountAddShop">
        <add-shop
            :shop-data="selectedShop"
            :site-id="selectedSite"
            @saved="shopSaveHandler"
            @close="closeAddShopModal"
        />
    </template>
    <template v-if="mountAddStore">
        <add-store
            @saved="storeSavedHandler"
