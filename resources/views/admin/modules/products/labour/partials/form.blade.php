    ...
    <portlet-content header="Product Type" subheader="Details" isform="true">
      <template slot="body">
        <div class="form-group m-form__group row" style="padding: 2% !important;">
          ...
          <div class="col-lg-6">
            <label class="required" for="unit_cost">Unit Cost</label>
            <input type="text"
        ...
        <div class="form-group m-form__group row" style="padding: 2% !important;">
          ...
          <div class="col-lg-6">
            <input type="checkbox" name="is_featured_labour_product" v-model="values.product_type.is_featured"> Is Featured
          </div>
        </div>
      </template>
    </portlet-content>
