...
<div class="col-xsmall-12 col-small-6">
  <portlet-content header="Company" subheader="Details" isform="true" height="865">
    <template slot="action_button" v-if="method==='post'">
      <button class="btn btn-primary auto-code-btn" @click="showCustomerList=true">Autocode</button>
    </template>
    <template slot="body">
              ...
              <div class="col-small-11 row pl-2">
                ...
                <div class="col-3">
                  ...
                  <span class="form-error"
                        v-if="form.errors.has('customerDetails.firstname')"
                        v-text="form.errors.get('customerDetails.firstname')"
                  ></span>
                </div>
                <div class="col-3">
          ...
          <div class="col-small-3">
            <div class="row">
              ...
              <div class="col-small-9">
                <input type="text"
                       name="code"
                       :disabled="!values.customerDetails.manual"
          ...
          <div class="col-xsmall-12">
            <div class="row">
              ...
              <div class="col-small-11">
                <input type="text"
                       name="project"
                       :class="{ 'input-error' : form.errors.has('quote.project'), 'form-control': loaded }"
                       v-model="values.quote.project"
                >
                <span class="form-error"
                      v-if="form.errors.has('quote.project')"
                      v-text="form.errors.get('quote.project')"></span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-xsmall-12">
            <div class="row">
              ...
              <div class="col-small-11">
									<textarea
                      rows="18"
                      v-model="values.quote.remarks"
                      placeholder="Remarks">
									</textarea>
                <span class="form-error"
                      v-if="form.errors.has('quote.remarks')"
                      v-text="form.errors.get('quote.remarks')"></span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-xsmall-12 col-small-6">
            <div class="row">
              ...
              <div class="col-small-7">
                <input type="text"
                       name="terms"
                       v-model="values.quote.term.name"
                       disabled
                       class="form-control"
                >
              </div>
...
<div class="col-xsmall-12 col-small-6">
  <div class="row">
    <div class="col-xsmall-12 col-small-4">
      <portlet-content header="Quote" subheader="Details" isform="true">
        <template slot="body">
          <div class="m-portlet__body">
            <div class="form-group m-form__group row" v-if="method==='patch'">
              <div class="col-xsmall-12">
                <div class="row quote-id">
                  <div class="col-small-4">
                    <label class="required">Quote Id:</label>
                  </div>
                  <div class="col-small-4">
                    <label class="required">@{{ quote.site.quote_prefix + '' + quote.quote_id }}</label>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="form-group m-form__group row">
              <div class="col-xsmall-12">
                <div class="row">
                  ...
                  <div class="col-small-9">
                    {{--<select--}}
                        {{--:class="{ 'input-error' : form.errors.has('quote.job_source_id'), 'form-control': loaded }"--}}
                        {{--v-model="values.quote.job_source_id"--}}
                    {{-->--}}
                      {{--<option value="">Select Job source</option>--}}
                      {{--<option v-for="(source, key) in jobSources" :value="key"--}}
                      {{-->--}}
                        {{--@{{ source.name }}--}}
                      {{--</option>--}}
                    {{--</select>--}}
                    <drop-down
                            ...
                            :options="jobSources"
                            label="title"
                            :value="values.quote.job_source_id"
                            @input="setDefaultSelectedJobSource"
                    />
                    <span class="form-error"
                          v-if="form.errors.has('quote.job_source_id')"
                          v-text="form.errors.get('quote.job_source_id')">
												</span>
              ...
              <div class="col-xsmall-12">
                <div class="row">
                  ...
                  <div class="col-small-9">
                    <input type="text"
                           name="town"
                           :class="{ 'input-error' : form.errors.has('values.quote.type'), 'form-control': loaded }"
                           :value="values.quote.type"
                    >
                    <span class="form-error"
                          v-if="form.errors.has('values.quote.type')"
                          v-text="form.errors.get('values.quote.type')"></span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <template slot="body">
          <div class="row">
            ...
            <drop-down
              ...
              class="col-6 pb-1"
              :options="accounts"
              v-model="values.quote.sales_code_id"
          ...
          <span 
            class="form-error"
            v-if="form.errors.has('quote.sales_code_id')">Sales Code is Required.
          </span>
        </template>
      </portlet-content>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-xsmall-12 table-wrap">
      <portlet-content header="Materials @ sell Price (incl. GST)" height="310">
        <template slot="body">
          <div class="form-group m-form__group row">
            <div class="col-small-1">
              <button class="btn btn-primary m-btn--sm" @click="openProductModal" :disabled="!selectedSite.id"><i class="fa fa-plus"></i></button>
            </div>
          </div>
          <span class="form-error"
            ...
            <div style="max-height: 230px;overflow-y: scroll;">
              <table class="table table-bordered">
                ...
                >
                  ...
                  <td style="width: 10%" class="pl-5" @click="openEditMaterialProductModal(material, index)">@{{ displayNumber(material.quantity) }}</td>
        ...
        <template slot="body">
          <div class="form-group m-form__group row">
            ...
            <div class="col-small-2">
              ...
              <button class="btn btn-primary m-btn--sm" style="margin-top: 0px"
            ...
            <div class="col-xsmall-12" style="max-height: 90px;overflow-y: scroll;">
              <table class="table table-bordered">
                ...
                >
                  ...
                  <td @click="openEditLabourProductModal(material)" style="width: 15%">@{{ displayNumber(material.quantity) }}</td>
    ...
    <div class="col-12">
      <portlet-content :onlybody="true">
        <div slot="body" class="py-2 px-1">
          <div class="row">
            <div class="col-3"> 
              <span class="background-black">
                Sell Price Costing
              </span>
              <button class="btn action-buttons" @click="openModal('ForceQuote')">Force Total</button>
            </div>
            <div class="col-9 row">
              <label class="col-7 text-right pr-2">Calculated Sell Total:</label>
              <input type="text" class="form-control col-5 text-primary" disabled :value="`$${materialLabourCostTotal}`"/>
              <label class="col-7 text-right pr-2">GST Inclusive Quote:</label>
              <input v-if="values.quote" type="text" class="form-control col-5 text-danger" disabled :value="'$' + values.quote.gst_inclusive_quote"/>
              <input v-else type="text" class="form-control col-5 text-danger" disabled value="$0"/>
              <label class="col-7 text-right pr-2">GST at @{{ values.quote.gst }}%:</label>
              <label class="col-5">@{{ displayMoney(values.quote.gst_amount) }}</label>
              <label class="col-7 text-right pr-2">Net Quote Price:</label>
              <label class="col-5">@{{ displayMoney(values.quote.quote_price) }}</label>
            </div>
          </div>
        </div>
      </portlet-content>
