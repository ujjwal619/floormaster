        ...
        <div class="row table-wrap">
          <table class="table">
              ...
              <tr class="row col-12">
                  ...
                  <td class="table-head col-2">Name</td>
          ...
          <table class="table">
            <tbody>
              <tr class="row col-12 pb-1"  v-for="journal in journals" :key="journal.id" @click="emitJournalClick(journal)" >
                ...
                <td class="form-control col-2">{{ journal.name }}</td>
                ...
                <td class="form-control text-primary text-right col-1">{{ displayMoney(journal.credit_amount) }}</td>
              </tr>
            </tbody>
          </table>
        </div>
