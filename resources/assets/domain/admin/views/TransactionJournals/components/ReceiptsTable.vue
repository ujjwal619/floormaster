        ...
        <div class="row table-wrap">
          <table class="table">
              ...
              <tr class="row col-12">
                  ...
                  <td class="table-head col-1">Account</td>
                  <td class="table-head col-1">&nbsp;</td>
          ...
          <table class="table">
            <tbody>
              <tr class="row col-12 pb-1"  v-for="journal in journals" :key="journal.id" @click="emitJournalClick(journal)" >
                ...
                <td class="form-control col-1">{{ journal.debit_account ? journal.debit_account.name : '' }}</td>
                <td class="form-control col-1">{{ journal.payment_method }}</td>
