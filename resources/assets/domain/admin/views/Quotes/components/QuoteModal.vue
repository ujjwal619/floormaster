<template>
  <modal title="Create New Quote" @close="handleClose" :is-large="isFirstPage">
    ...
    <template slot="modal-body">
      <div v-show="isFirstPage">
        ...
        <div class="row pt-3">
          <label class="col-2 text-right">(7) Enter Quote Date</label>
          <input
            ...
            v-validate="'required'"
          />
          <label class="error">{{ errors.first('quote date') }}</label>
        </div>
        <div class="row pt-3">
          <div class="col-6 row">
            <fieldset>
...
import ChoosePrimaryRep from "./ChoosePrimaryRep.vue";
import Modal from "../../../../common/components/Modal/Modal";
import DropDown from "../../../../common/components/DropDown/DropDown";
import { LoadingMixin } from '../../../../common/mixins'
import { formatDate } from '../../../../common/utitlities/helpers';

const PAGE_LIST = ["CopyQuote", "SelectClient", "ChoosePrimaryRep"];
...
export default {
  ...
  computed: {
    sourceName() {
      return this.jobSources.find(
        jobSource => jobSource.id === this.model.source_id
      ).name;
    },
    isFirstPage() {
      return this.page === 1;
