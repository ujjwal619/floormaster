...
# Application #
#####################################################################################
set :application,     'FloorMIS'
set :branch,          ENV["branch"] || "master"
set :user,            ENV["user"] || ENV["USER"] || "fms"


# SCM #
#####################################################################################
set :repo_url,        'git@gitlab.com:innohub/floor-management.git'
set :repo_base_url,   :'http://gitlab.com'
set :repo_diff_path,  :'innohub/floor-management/compare/master...'
set :repo_branch_path,:'innohub/floor-management/tree'
set :repo_commit_path,:'innohub/floor-management/commit'
...
# Slack Integration #
#####################################################################################
set :slack_incoming_hook_url,   "https://hooks.slack.com/services/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"
